...
include_graphics('Beasley-30.jpg') 
```
<br>
<br>
<br>
...
I’m currently a postdoctoral fellow at Boston University. I’m interested in how ecological processes differ across spatial, temporal, and hierarchical scales. Currently, my work focuses on forecasting tick population dynamics, with the eventual goal of using these forecasts to aid tick-borne disease management. 
...
#### Forecasting tick populations using remotely-sensed data

Tick-borne diseases are an ongoing wildlife and public health concern in North America, particularly as changes in climate and land use expand the range and density of many tick species. Accurate forecasts of tick populations are a promising tool for managing tick-borne diseases; allowing land managers make risk-informed decisions and public health agencies to deliver education campaigns before the onset of the tick questing season. Building upon work by Foster et al., I will calibrate an existing forecasting model to allow for site-level variation in tick population responses to environmental covariates, add remotely sensed data to improve predictions, validate these changes using incoming tick survey data, and assimilate these new data into the model workflow. I will then develop an automated pipeline that will generate weekly forecasts of tick populations up to 12 months into the future.
...
Ramírez-Guerrero, G., Banville, F., **Beasley, E.M.**, Poisot, T., & Cameron, C.B. Palaeoecological food webs through the Ordovician-Silurian extinction event of Anticosti Island, Québec. In review at *Lethaia*. 
