...
Despite the current outbreak, Burlington was previously rabies-free from 2017-2022, indicating that characteristics of the urban environment may make rabies elimination possible at lower seroprevalence thresholds. I will explore these ideas by using agent-based models to answer two questions: 1) At what seroprevalence rate is rabies eliminated with a 95% probability over a 10-year preiod? 2) Does landscape structure affect probability of elimination or time to elimination? I anticipate that the threshold for local elimination will be less than the 60% previously thought to be required, and that landscape barriers such as rivers and highways will lower seroprevalence thresholds further by subdividing raccoon populations.
...
These methods have complementary strengths, and may be able to generate more accurate predictions if used in tandem. I will use approximate Bayesian computation (ABC) as a method to bridge these two methods (Fig. 1- coming soon!) and more accurately identify possible rabies risk corridors at the US-Canada border.
